...
<div class="ewvwp-product">
        <div class="ewvwp-make3D">
            ...
            <div class="ewvwp-product-back">
                <div class="ewvwp-shadow"></div>
                <form class="voting-form" onsubmit="return easyWpVotingForm(event, <?php print get_the_ID(); ?>)" action="#" method="post" id="easy-wp-voting-form-<?php print get_the_ID(); ?>" data-form="<?php print get_the_ID(); ?>" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
                    ...
                    <button type="submit" id="voting-button">Vote</button>
                    <p><?php print(get_option('ewvwp_min_amount')); ?>NGN per 1 vote</p>
                </form>
                <small class="text-success form-control-msg voting-form-success-<?php print get_the_ID(); ?>" style="display:none; margin:0 auto 100px">Vote Successfully submitted, thank you!</small>
                <small class="text-danger form-control-msg voting-form-error-<?php print get_the_ID(); ?>" style="display:none; margin:0 auto 100px">There was a problem with the Inquiry Form, please try again!</small>
            ...
            jQuery.ajax({
                ...
                success : function( response ){
                    ...
                    if(response.success == true){
                        //$('#voting-form-'+formid).css('display', 'none');
                        //$('.voting-form-success-'+formid).css({'display':'block'})
