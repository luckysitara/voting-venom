...
/*
Plugin Name: Voting-Payment
Description: Voting-Payment allows you to create a simple voting system with payment method
Author: Bughacker
Version: 1.0
...
function venom_shortcode( $atts, $content = null ){
	...
	ob_start();
	include plugin_dir_path(__FILE__) . 'templates/venom.php';
	return ob_get_clean();
