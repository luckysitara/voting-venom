        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input type="number" name="voting_plugin_amount_per_vote" value="<?php echo esc_attr(get_option('voting_plugin_amount_per_vote')); ?>" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Paystack Test Secret Key</th>
                    <td><input type="text" name="voting_plugin_paystack_test_secret_key" value="<?php echo esc_attr(get_option('voting_plugin_paystack_test_secret_key')); ?>" /></td>
                </tr>
            </table>
            <?php submit_button(); ?>
        </form>
...
function voting_plugin_contestants_page() {
    ...
    if (isset($_POST['add_contestant'])) {
        ...
        if ($user_info) {
            ...
            echo '<div class="updated"><p>User added as contestant successfully.</p></div>';
        } else {
            echo '<div class="error"><p>Error: User not found or already added as contestant.</p></div>';
        }
    }
    ...
    if (isset($_POST['remove_contestant'])) {
        ...
        echo '<div class="updated"><p>Contestant removed successfully.</p></div>';
    }
